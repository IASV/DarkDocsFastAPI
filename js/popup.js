...
.swagger-ui .btn:hover {
  box-shadow: 1px 1px 3px rgb(0 0 0 / 80%);
}
...
.swagger-ui .opblock.opblock-post .parameter__name.required::after {
  color: blue;
}
.swagger-ui .parameter__name.required {
  color: white;
...
.swagger-ui .opblock.opblock-put .arrow {
  fill: #fca130;
}
.swagger-ui .opblock.opblock-put .opblock-summary {
  background: #784212;
...
.swagger-ui .opblock.opblock-delete .opblock-body {
  background: transparent;
  box-shadow: 1px 1px 5px black;
  /* border: 1px solid white; */
}
...
/* Generals sections*/
.swagger-ui .opblock.opblock-delete, .swagger-ui .opblock.opblock-post, .swagger-ui .opblock.opblock-put, .swagger-ui .opblock.opblock-delete {
  background: transparent;
  border-color: transparent;
}
...
.swagger-ui section.models h4 {
  border-bottom: 3px solid #005873 !important;
  border-radius: 10px;
}
